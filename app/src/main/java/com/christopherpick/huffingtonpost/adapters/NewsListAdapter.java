...
public class NewsListAdapter extends CursorAdapter {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		articleTitle.setText(cursor.getString(cursor.getColumnIndexOrThrow(HuffingtonPostContract.COLUMN_TITLE)));
		articleSummary.setText(cursor.getString(cursor.getColumnIndexOrThrow(HuffingtonPostContract.COLUMN_SUMMARY)));
	}
